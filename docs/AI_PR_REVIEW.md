...
1. Record the PR head commit, base commit, changed files, and scan ID. Match each changed file to the findings in that scan. Confirm the branch is based on the expected repository and commit.
